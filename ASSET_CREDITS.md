...
## KayKit Restaurant Bits kitchen appliances

The kitchen showroom uses local copies of selected models from **KayKit Restaurant Bits** by Kay Lousberg / KayKit:
...
License: **CC0** — free for personal and commercial use; attribution is not required. The local copies preserve the original glTF geometry, binary buffers, and shared texture.
