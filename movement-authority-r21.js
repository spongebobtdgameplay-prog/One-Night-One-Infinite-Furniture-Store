...
function ResolveInputAxis(Camera, Desired) {
  ...
  const SlideRatio = THREE.MathUtils.clamp(TangentLength / DesiredLength, 0, 1);
...
PointerLockControls.prototype.moveForward = function MoveForwardWithWallFollow(Distance) {
  ...
  ResolveInputAxis(Camera, Scratch.Desired);
};

PointerLockControls.prototype.moveRight = function MoveRightWithWallFollow(Distance) {
  const Camera = ControlCamera(this);
...
window.__STORE_MOVEMENT_AUTHORITY_BUILD__ = "V0.12.22";
