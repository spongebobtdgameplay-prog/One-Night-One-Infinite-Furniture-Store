...
if (!Game?.Scene || !Game?.CollisionBoxes || !Game?.ActiveChunks) throw new Error("Game must load before R42 precise collision.");
...
window.__STORE_PRECISION_COLLISION_BUILD__ = "V0.11-R42";
