...
Style.id = "FastUiStyleR96";
Style.textContent = `
html,body{scroll-behavior:auto!important}
#BootScreen,#NetworkOverlayR93,#RuntimeMainMenuR83,#SettingsOverlayR43,#AccountGateR92{
  backdrop-filter:none!important;-webkit-backdrop-filter:none!important;
  transition:none!important;animation:none!important
}
#BootScreen .BootCard,#NetworkOverlayR93 .NetFrameR93,#RuntimeMainMenuR83 .BootCard,#SettingsOverlayR43 .R43SettingsPanel,.AccountGateShellR92{
  backdrop-filter:none!important;-webkit-backdrop-filter:none!important;
  transition:none!important;animation:none!important;contain:layout paint style
}
#BootScreen *,#NetworkOverlayR93 *,#RuntimeMainMenuR83 *,#SettingsOverlayR43 *,#AccountGateR92 *{transition-duration:0s!important}
#BootScreen button,#NetworkOverlayR93 button,#NetworkOverlayR93 input,#NetworkOverlayR93 select,
...
#NetworkOverlayR93{background:rgba(4,5,4,.985)!important}
#RuntimeMainMenuR83{background:rgba(4,5,4,.98)!important}
#SettingsOverlayR43{background:rgba(3,4,5,.985)!important}
#OpenMainMenuR83,#FpsCounterR43,#Hud .ClockCard,#Hud .RunStats,#Hud .StaminaHud,#Hud .CameraMode,#Hud .InteractPrompt{
  backdrop-filter:none!important;-webkit-backdrop-filter:none!important
}
#UiInstantFeedbackR95{position:fixed;left:50%;top:18px;z-index:2100;display:none;transform:translateX(-50%);padding:8px 12px;border:1px solid rgba(222,207,180,.28);background:#101310;color:#e9dec9;font:900 10px Arial,sans-serif;letter-spacing:.12em;text-transform:uppercase;pointer-events:none}
#UiInstantFeedbackR95.Show{display:block}.StoreFastPressR95{filter:brightness(1.18)!important}
`;
...
const WatchedIds = ["BootScreen", "NetworkOverlayR93", "RuntimeMainMenuR83", "SettingsOverlayR43", "AccountGateR92"];
const Observers = [];
...
function IsElementOpen(Id, Element) {
  ...
  if (Id === "NetworkOverlayR93") return Element.classList.contains("Open");
